...
from config import POMO_CONFIG, USER_TZ
from pomo_store import load_pomos
from pomo_queries import get_today_receipt
from quest_store import load_quests
from utils import compute_metrics, compute_pomo_metrics, fantasy_date
...
class DashboardModal(ModalScreen):
    ...
    def on_mount(self) -> None:
        quest_metrics = compute_metrics(load_quests())
        pomo_metrics  = compute_pomo_metrics(load_pomos())
