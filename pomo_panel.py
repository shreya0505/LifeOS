...
from pomo_queries import get_quest_segment_journey
from renderers import POMO_WAR_CRIES, render_block_clock, render_health_bar, render_momentum_bar
...
class PomodoroPanel(Screen):
    ...
    def _build_journey(self, seg_type: str, lap: int, session: dict,
        ...
        all_sessions       = get_quest_segment_journey(quest_id)
